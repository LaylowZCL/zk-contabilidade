		...
		if (lightDarkBtn && lightDarkBtn.length) {
			lightDarkBtn[0].addEventListener("click", function (event) {
				html.hasAttribute("data-bs-theme") && html.getAttribute("data-bs-theme") == "dark" ?
					setLayoutMode("data-bs-theme", "light", "layout-mode-light", html) : setLayoutMode("data-bs-theme", "dark", "layout-mode-dark", html);
				html.hasAttribute("data-bs-theme") && html.getAttribute("data-bs-theme") == "dark" ?
					setLayoutMode("data-sidebar", "dark", "data-sidebar", html) : setLayoutMode("data-sidebar", "light", "data-sidebar", html);
				sessionStorage.setItem("data-sidebar", html.getAttribute("data-sidebar"));
			});
		}
	}
