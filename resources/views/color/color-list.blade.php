...
@section('body')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @endslot
            @slot('pagetitle')
                {{ __('translation.Color List') }}
            @endslot
        @endcomponent

        <div class="row pb-4 gy-3">
            <div class="col-sm-4">
                <button class="btn btn-primary addcolor-modal" data-bs-toggle="modal" data-bs-target="#addcolorModal"><i
                        class="las la-plus me-1"></i> {{ __('translation.Add Color') }}</button>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-4">
                        <form method="post" action="{{ url('add-color') }}" autocomplete="off" id="colorform"
                            class="needs-validation" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="colorName" class="form-label">{{ __('translation.Color Name') }}<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control @error('color_name') is-invalid @enderror"
                                            name="color_name" id="colorName" placeholder="Enter Color Name" required>
                                    ...
                                    <div class="hstack gap-2 justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-success"
                                            id="addNewColor">{{ __('translation.Add Color') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        <div class="modal fade" id="editColorModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-4">
                        <form method="post" action="{{ url('update-color') }}" autocomplete="off" id="colorform"
                            class="needs-validation" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="editColorName"
                                            class="form-label">{{ __('translation.Color Name') }}</label>
                                        <input type="text" class="form-control" name="color_name" id="editColorName"
                                    ...
                                    <div class="hstack gap-2 justify-content-end">
                                        <button type="button" class="btn btn-light"
                                            data-bs-dismiss="modal">{{ __('translation.Close') }}</button>
                                        <button type="submit" class="btn btn-success"
                                            id="addNewColor">{{ __('translation.Update Color') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
