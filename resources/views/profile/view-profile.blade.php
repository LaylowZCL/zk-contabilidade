        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('update-profile') }}" class="needs-validation" novalidate
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="username" id="username" placeholder="Enter username"
                                            ...
                                            autocomplete="off" value="{{ $user->username }}" readonly>
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" name="email" id="email" placeholder="Enter email"
                                            ...
                                            autocomplete="off" readonly value="{{ $user->email }}" readonly>
                                ...
                                <div class="col-xl-6">
                                    <div class="mb-3">
                                        <label>{{ __('translation.Profile Image') }}</label><span
                                            class="text-danger">*</span>
                                        <input type="file" name="profile_image" id="profile_image" class="form-control"
                                            onchange="displayProfile(this)">
                                        <div class="text-center mt-4">
                                            @if ($user->profile_image !== null || $user->profile_image !== '')
                                                <img src="{{ URL::asset('build/images/users/' . $user->profile_image) }}"
                                                    alt="" class="img-fluid" height="100px" width="100px"
                                                    id="profile_display" style="border-radius:50%!important">
                                            @else
                                ...
                                <div class="hstack justify-content-end d-print-none mt-2">
                                    <button type="submit" class="btn btn-success"><i
                                            class="align-bottom me-1"></i>{{ __('translation.Save') }}</button>
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('update-password') }}" class="needs-validation" novalidate
                            id="password_form" enctype="multipart/form-data">
                            @csrf
                            <div class="row">

                                <div class="col-xl-12">
                                    <div class="mb-3">
                                        <label>{{ __('translation.Old Password') }}</label><span
                                            class="text-danger">*</span>
                                ...
                                <div class="col-xl-12">
                                    <div class="mb-3">
                                        <label>{{ __('translation.New Password') }}</label><span
                                            class="text-danger">*</span>
                                ...
                                <div class="col-xl-12">
                                    <div class="mb-3">
                                        <label>{{ __('translation.Re-enter Password') }}</label><span
                                            class="text-danger">*</span>
                                ...
                                <div class="hstack justify-content-end d-print-none mt-2">
                                    <button type="submit" class="btn btn-success"><i
                                            class="align-bottom me-1"></i>{{ __('translation.Update') }}</button>
                                </div>
                            </div>
