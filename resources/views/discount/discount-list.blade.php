        ...
        <div class="row pb-4 gy-3">
            <div class="col-sm-4">
                <button class="btn btn-primary addtax-modal" data-bs-toggle="modal" data-bs-target="#addtaxModal"><i
                        class="las la-plus me-1"></i> {{ __('translation.Add Discount') }}</button>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-4">
                        <form method="post" action="{{ url('add-discount') }}" autocomplete="off" id="taxform"
                            class="needs-validation" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="discountName" class="form-label">{{ __('translation.Name') }}<span
                                    ...
                                    <div class="mb-3">
                                        <label for="discountRate" class="form-label">{{ __('translation.Rate') }} (In
                                            %)<span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" id="discountRate" name="discountRate"
                                            placeholder="Enter discount rate" required>
                                    ...
                                    <div class="hstack gap-2 justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-success"
                                            id="addNewTax">{{ __('translation.Add Discount') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        <div class="modal fade" id="editTaxModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-4">
                        <form method="post" action="{{ url('update-discount') }}" autocomplete="off" id="taxform"
                            class="needs-validation" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="editDiscountName"
                                            class="form-label">{{ __('translation.Name') }}<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="discountName"
                                            id="editDiscountName" placeholder="Enter discount name" required>
                                    ...
                                    <div class="mb-3">
                                        <label for="editDiscountRate" class="form-label">{{ __('translation.Rate') }} (In
                                            %)<span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" id="editDiscountRate"
                                            name="discountRate" placeholder="Enter discount rate" required>
                                    ...
                                    <div class="hstack gap-2 justify-content-end">
                                        <button type="button" class="btn btn-light"
                                            data-bs-dismiss="modal">{{ __('translation.Close') }}</button>
                                        <button type="submit" class="btn btn-success"
                                            id="addNewTax">{{ __('translation.Update Discount') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
