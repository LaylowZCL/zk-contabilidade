...
@section('title')
    {{ __('translation.Shipping Charge') }}
@endsection
@section('css')
    <!--datatable css-->
...
@section('body')
    ...
    @section('content')
        ...
        <div class="row pb-4 gy-3">
            <div class="col-sm-4">
                <button class="btn btn-primary addtax-modal" data-bs-toggle="modal" data-bs-target="#addtaxModal"><i
                        class="las la-plus me-1"></i> {{ __('translation.Add Charge') }}</button>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-4">
                        <form method="post" action="{{ url('add-shipping-charge') }}" autocomplete="off" id="taxform"
                            class="needs-validation" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="taxName" class="form-label">{{ __('translation.Tax Name') }}<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="taxName" id="taxName"
                                    ...
                                    <div class="mb-3">
                                        <label for="taxRate" class="form-label">{{ __('translation.Tax Rate') }} (In
                                            %)<span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" id="taxRate" name="taxRate"
                                            placeholder="Enter Text Rate" required>
                                    </div>
                                    @error('taxRate')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                    ...
                                    <div class="hstack gap-2 justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-success"
                                            id="addNewTax">{{ __('translation.Add Tax') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        <div class="modal fade" id="editTaxModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-4">
                        <form method="post" action="{{ url('update-shipping-charge') }}" autocomplete="off"
                            id="taxform" class="needs-validation" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="editTaxName" class="form-label">{{ __('translation.Tax Name') }}<span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-3">
                                        <label for="editCountry" class="form-label">{{ __('translation.Country') }}<span
                                                class="text-danger">*</span></label>
                                        <select class="form-select" aria-label="Default select example" name="country"
                                            id="editCountry" required>
                                            <option value="">Select Country</option>
                                            <option value="Afghanistan">Afghanistan</option>
                                            <option value="Albania">Albania</option>
                                            <option value="Algeria">Algeria</option>
                                    ...
                                    <div class="mb-3">
                                        <label for="editTaxRate" class="form-label">{{ __('translation.Tax Rate') }} (In
                                            %)<span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" id="editTaxRate" name="taxRate"
                                            placeholder="Enter Text Rate" required>
                                    </div>
                                    @error('taxRate')
                                        <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="hstack gap-2 justify-content-end">
                                        <button type="button" class="btn btn-light"
                                            data-bs-dismiss="modal">{{ __('translation.Close') }} </button>
                                        <button type="submit" class="btn btn-success"
                                            id="addNewTax">{{ __('translation.Update Charge') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
