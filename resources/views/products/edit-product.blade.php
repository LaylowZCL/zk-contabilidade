                        ...
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <span class="pip">
                                        <img class="imageThumb mt-2 " src="{{URL::asset('/build/images/products/'.$products->product_image)}}"><br>
                                    </span>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    @foreach($products->product_images as $key => $value)
                                        <span class="pip_sub">
                                            <img class="imageThumb mt-2 " src="{{URL::asset('/build/images/products/'.$value['image'])}}"><br>
