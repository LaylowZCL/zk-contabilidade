...
@section('body')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @endslot
            @slot('pagetitle')
                {{ __('translation.Product List') }}
            @endslot
        @endcomponent

        <div class="row pb-4 gy-3">
            <div class="col-sm-4">
                <a href="{{ url('add-product-view') }}" class="btn btn-primary addtax-modal"><i class="las la-plus me-1"></i>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive table-card">
                            <table class="table nowrap dt-responsive align-middle table-hover table-bordered mb-0" id="productListTable">
                                <thead>
                                    <tr>
                            ...
                            @foreach ($products as $key => $product)
                                ...
                                <input type="hidden" id="product_name_{{ $product->id }}"
                                    value="{{ @$product->product_name }}">
                                <input type="hidden" id="brand_{{ $product->id }}" value="{{ @$product->brand->name }}">
                                <input type="hidden" id="category_{{ $product->id }}"
                                ...
                                <input type="hidden" id="product_image_{{ $product->id }}"
                                    value="{{ URL::asset('/build/images/products/' . $product->product_image) }}">
                                <input type="hidden" id="description_{{ $product->id }}"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-4">
                        <form method="POST" action="#" autocomplete="off" id="productform" class="needs-validation"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                            ...
                                            <div class="avatar-lg">
                                                <div class="avatar-title bg-light rounded-circle">
                                                    <img src="{{ URL::asset('/build/images/users/user-dummy-img.jpg') }}"
                                                        id="viewProductImage" class="avatar-md rounded-circle h-auto" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-2 mt-2">
                                            <label for="productName"
                                                class="form-label">{{ __('translation.Product Name') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="viewProductName" readonly>
                                        </div>
                                        <div class="col-lg-6 mb-2 mt-2">
                                            <label for="brandName"
                                                class="form-label">{{ __('translation.Brand Name') }}<span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-2 mt-2">
                                            <label for="category"
                                                class="form-label">{{ __('translation.Category') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="viewCategory" readonly>
                                        </div>
                                        <div class="col-lg-6 mb-2 mt-2">
                                            <label for="color" class="form-label">{{ __('translation.Color') }}<span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-2 mt-2">
                                            <label for="price" class="form-label">{{ __('translation.Price') }}<span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-2 mt-2">
                                        <label for="description"
                                            class="form-label">{{ __('translation.Description') }}<span
                                                class="text-danger">*</span></label>
    ...
    @section('scripts')
        ...
        <script>
            ...
            function viewProductData(productId) {
                if (productId) {
                    document.getElementById('viewProductName').value = document.getElementById('product_name_' +
                        productId).value;
                    document.getElementById('viewBrand').value = document.getElementById('brand_' + productId).value;
                    document.getElementById('viewCategory').value = document.getElementById('category_' + productId)
                        .value;
                    ...
                    document.getElementById('viewDescription').value = document.getElementById('description_' +
                        productId).value;
                    document.getElementById('viewProductImage').src = document.getElementById('product_image_' +
                        productId).value;
                }
            }
        </script>
