...
@section('body')
    ...
    @section('content')
        @component('components.breadcrumb')
            ...
            @endslot
            @slot('pagetitle')
                {{ __('translation.Category List') }}
            @endslot
        @endcomponent

        <div class="row pb-4 gy-3">
            <div class="col-sm-4">
                <button class="btn btn-primary addcategory-modal" data-bs-toggle="modal"
                    data-bs-target="#addcategoryModal"><i class="las la-plus me-1"></i>
                    {{ __('translation.Add Category') }}</button>
            </div>
        </div>
                            ...
                            <table class="table nowrap dt-responsive align-middle table-hover table-bordered mb-0"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">{{ __('translation.Created At') }}</th>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-4">
                        <form method="post" action="{{ url('add-category') }}" autocomplete="off" id="categoryform"
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="categoryName"
                                            class="form-label">{{ __('translation.Category Name') }}<span
                                    ...
                                    <div class="hstack gap-2 justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-success"
                                            id="addNewCategory">{{ __('translation.Add Category') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        <div class="modal fade" id="editCategoryModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-4">
                        <form method="post" action="{{ url('update-category') }}" autocomplete="off" id="categoryform"
                            class="needs-validation" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label for="editCategoryName"
                                            class="form-label">{{ __('translation.Category Name') }}</label>
                                        <input type="text" class="form-control" name="category_name"
                                            id="editCategoryName" placeholder="Enter Category Name" required>
                                    ...
                                    <div class="hstack gap-2 justify-content-end">
                                        <button type="button" class="btn btn-light"
                                            data-bs-dismiss="modal">{{ __('translation.Close') }}</button>
                                        <button type="submit" class="btn btn-success"
                                            id="addNewCategory">{{ __('translation.Update Category') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        <script>
            ...
            (function() {
                ...
                function editCategoryData(categoryId) {
                    if (categoryId) {
                        document.getElementById('editCategoryName').value = document.getElementById('name_' + categoryId)
                            .value;
