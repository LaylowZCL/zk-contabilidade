        ...
        <div class="row pb-4 gy-3">
            <div class="col-sm-4">
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addCompanyModal"><i
                        class="las la-plus me-1"></i> {{ __('translation.Add Company') }}</button>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="table-card">
                            <table class="table nowrap dt-responsive align-middle table-hover table-bordered mb-0"
                                ...
                                <thead>
                                    <tr class="text-muted">
                                        ...
                                        <th scope="col" width="50">{{ __('translation.Status') }}</th>
                            ...
                            @foreach ($companies as $key => $company)
                                <input type="hidden" id="company_name_{{ $company->id }}"
                                ...
                                <input type="hidden" id="mobile_number_{{ $company->id }}"
                                    value="{{ @$company->mobile_number }}">
                                <input type="hidden" id="address_{{ $company->id }}" value="{{ @$company->address }}">
                                <input type="hidden" id="postalcode_{{ $company->id }}"
                                    value="{{ @$company->postalcode }}">
                                <input type="hidden" id="invoice_slug_{{ $company->id }}"
                                    value="{{ @$company->invoice_slug }}">
                                <input type="hidden" id="logo_{{ $company->id }}"
                                    value="{{ URL::asset('build/images/logo/' . $company->logo) }}">
                            @endforeach
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-4">
                        <form method="POST" action="{{ url('add-company') }}" autocomplete="off" id="companyform"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="text-center mb-2">
                                        <div class="position-relative d-inline-block">
                                            <div class="position-absolute bottom-0 end-0">
                                                ...
                                                <input class="form-control d-none @error('logo') is-invalid @enderror"
                                                    value="" id="member-image-input" type="file" name="logo"
                                                    accept="image/png, image/gif, image/jpeg" onchange="displayLogo(this)"
                                                    required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-2 mt-2">
                                            <label for="website"
                                                class="form-label">{{ __('translation.Website Url') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="url"
                                                class="form-control @error('website') is-invalid @enderror" id="website"
                                                value="{{ old('website') }}" name="website" placeholder="Enter website"
                                                required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-2 mt-2">
                                            <label for="mobile_number"
                                                class="form-label">{{ __('translation.Contact No') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="number"
                                                class="form-control @error('mobile_number') is-invalid @enderror"
                                                value="{{ old('mobile_number') }}" id="mobile_number"
                                                name="mobile_number" placeholder="Enter contact number" required>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-2 mt-2">
                                            <label for="postalcode"
                                                class="form-label">{{ __('translation.Postalcode') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('postalcode') is-invalid @enderror"
                                                id="postalcode" name="postalcode" placeholder="Enter postalcode"
                                        ...
                                        <div class="col-lg-6 mb-2 mt-2">
                                            <label for="invoiceSlug"
                                                class="form-label">{{ __('translation.Invoice Number Slug') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('invoice_slug') is-invalid @enderror"
                                                value="{{ old('invoice_slug') }}" id="invoiceSlug" name="invoice_slug"
                                                placeholder="Enter invoice slug" required>
                                    ...
                                    <div class="mb-2">
                                        <label class="form-label" for="address">{{ __('translation.Address') }}<span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="hstack gap-2 justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-success"
                                            id="addNewCompany">{{ __('translation.Add Company') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        <div class="modal fade" id="editCompanyModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content border-0">
                    ...
                    <div class="modal-body p-4">
                        <form method="POST" action="{{ url('update-company') }}" autocomplete="off"
                            id="editCompanyform" class="needs-validation" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <input type="hidden" id="memberid-input" class="form-control" value="">
                                    ...
                                    <div class="text-center mb-2">
                                        <div class="position-relative d-inline-block">
                                            <div class="position-absolute bottom-0 end-0">
                                                <label for="editCompanyLogo" class="mb-0" data-bs-toggle="tooltip"
                                                    data-bs-placement="right" title="Select Company Logo">
                                                    <div class="avatar-xs">
                                                        <div
                                                            class="avatar-title bg-light border rounded-circle text-muted cursor-pointer">
                                                ...
                                                <input class="form-control d-none @error('logo') is-invalid @enderror"
                                                    value="" id="editCompanyLogo" type="file" name="logo"
                                                    accept="image/png, image/gif, image/jpeg"
                                                    onchange="editCompnyLogo(this)">
                                            ...
                                            <div class="avatar-lg">
                                                <div class="avatar-title bg-light rounded-circle">
                                                    <img src="{{ URL::asset('/build/images/users/user-dummy-img.jpg') }}"
                                                        id="editLogo" class="avatar-md rounded-circle h-auto" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-2 mt-2">
                                            <label for="editWebsite"
                                                class="form-label">{{ __('translation.Website') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="url"
                                                class="form-control @error('website') is-invalid @enderror"
                                                id="editWebsite" name="website" placeholder="Enter website" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 mb-2 mt-2">
                                            ...
                                            <input type="number"
                                                class="form-control @error('mobile_number') is-invalid @enderror"
                                                id="editMobileNumber" name="mobile_number"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-2 mt-2">
                                            <label for="editPostalcode"
                                                class="form-label">{{ __('translation.Postalcode') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('postalcode') is-invalid @enderror"
                                                id="editPostalcode" name="postalcode" placeholder="Enter postalcode"
                                                required>
                                        ...
                                        <div class="col-lg-6 mb-2 mt-2">
                                            <label for="editInvoiceSlug"
                                                class="form-label">{{ __('translation.Invoice Number Slug') }}<span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                class="form-control @error('invoice_slug') is-invalid @enderror"
                                                id="editInvoiceSlug" name="invoice_slug" placeholder="Enter invoice slug"
                                                required>
                                    ...
                                    <div class="hstack gap-2 justify-content-end">
                                        <button type="button" class="btn btn-light"
                                            data-bs-dismiss="modal">{{ __('translation.Close') }}</button>
                                        <button type="submit" class="btn btn-success"
                                            id="addNewClient">{{ __('translation.Update Company') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            function editCompanyData(companyId) {
                if (companyId) {
                    document.getElementById('editCompanyName').value = document.getElementById('company_name_' +
                        companyId).value;
                    document.getElementById('editWebsite').value = document.getElementById('website_' + companyId)
                        .value;
                    ...
                    document.getElementById('editMobileNumber').value = document.getElementById('mobile_number_' +
                        companyId).value;
                    document.getElementById('editAddress').value = document.getElementById('address_' + companyId)
                        .value;
                    document.getElementById('editPostalcode').value = document.getElementById('postalcode_' + companyId)
                        .value;
                    document.getElementById('editInvoiceSlug').value = document.getElementById('invoice_slug_' +
                        companyId).value;
