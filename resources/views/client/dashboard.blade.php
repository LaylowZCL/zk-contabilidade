                    ...
                    <div class="row align-items-center gy-4">
                        ...
                        <div class="col-sm-4">
                            <div class="text-center px-2">
                                <img src="{{ URL::asset('build/images/invoice-widget.png') }}" class="img-fluid invoice-widget" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-8">
                            <div class="d-flex main-chart justify-content-end">
                                <div class="px-4 border-end">
                                    <h4 class="text-primary fs-18 mb-0">$584k <span class="text-muted d-inline-block fs-17 align-middle ms-0 ms-sm-2">Incomes</span></h4>
                                </div>
                                <div class="ps-4">
                                    <h4 class="text-primary fs-18 mb-0">$324k <span class="text-muted d-inline-block fs-17 align-middle ms-0 ms-sm-2">Expenses</span></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="table table-centered align-middle table-nowrap mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('build/images/flags/us.svg') }}" class="rounded" alt="user-image" height="22">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('build/images/flags/italy.svg') }}" class="rounded" alt="user-image" height="22">
                                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('build/images/flags/spain.svg') }}" class="rounded" alt="user-image" height="22">
                                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('build/images/flags/french.svg') }}" class="rounded" alt="user-image" height="22">
                                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('build/images/flags/russia.svg') }}" class="rounded" alt="user-image" height="22">
                                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('build/images/flags/ae.svg') }}" class="rounded" alt="user-image" height="22">
                                                        <div class="flex-grow-1 ms-3">
                    ...
                    <table class="table table-striped table-nowrap align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" alt="" class="avatar-xs rounded-circle me-2">
