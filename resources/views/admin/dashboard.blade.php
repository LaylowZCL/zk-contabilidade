...
@section('css')
    <!-- flatpicker css -->
    <link rel="stylesheet" href="{{ URL::asset('build/libs/flatpickr/flatpickr.min.js') }}">
@endsection
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center gy-4">
                            <div class="col-sm-8">
                                <div class="box">
                                    <h5 class="fs-20 text-truncate">{{ __('translation.Professional Invoices Made Easy') }}.
                                    </h5>
                                    <p class="text-muted fs-15">
                                        {{ __('translation.Quickly understand who your best customers little and motivation to pay thair bills') }}.
                                    </p>
                            ...
                            <div class="col-sm-4">
                                <div class="text-center px-2">
                                    <img src="{{ URL::asset('/build/images/invoice-widget.png') }}" class="img-fluid"
                                        style="height: 141px;" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-3 mini-widget pb-3 pb-lg-0">
                                <div class="d-flex align-items-end">
                                    <div class="flex-grow-1">
                                        <h2 class="mb-0 fs-24"><span class="counter-value" data-target=""
                                                id="clientsAdded"></span></h2>
                ...
                <div class="card">
                    ...
                    <div class="card-body py-1">
                            ...
                            <div class="col-md-8">
                                <div class="d-flex main-chart justify-content-end">
                                    <div class="px-4 border-end">
                                        <h4 class="text-primary fs-18 mb-0" id="paymenActivityPaid"> <span
                                                class="text-muted d-inline-block fs-17 align-middle ms-0 ms-sm-2">{{ __('translation.Paid') }}</span>
                                        </h4>
                                    </div>
                                    <div class="ps-4">
                                        <h4 class="text-primary fs-18 mb-0" id="paymenActivityUnpaid"> <span
                                                class="text-muted d-inline-block fs-17 align-middle ms-0 ms-sm-2">{{ __('translation.Unpaid') }}</span>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="stacked-column-chart" class="apex-charts"
                            data-colors='["--in-primary", "--in-light-rgb, 1.0"]' dir="ltr"></div>
                    </div>
                </div>
            </div>
            <div class="col-xl-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-shrink-0 ms-2">
                                <div class="dropdown">
                                    <input type="date" class="form-control" id="structureDatePicker"
                                        name="structureDatePicker" placeholder="Select date range">
                        ...
                        <div id="structure-widget"
                            data-colors='["--in-primary", "--in-primary-rgb, 0.7", "--in-danger-rgb, 0.9"]'
                            class="apex-charts" dir="ltr"></div>

                        <div class="px-2">
                            <div class="structure-list d-flex justify-content-between border-bottom">
                                <p class="mb-0"><i
                                        class="las la-dot-circle fs-18 text-primary me-2"></i>{{ __('translation.Paid') }}
                                </p>
                                <div>
                                    <span class="badge bg-primary" id="paidAmt"> ${{ $totalAmountOfPaidInvoices }}
                                    </span>
                            ...
                            <div class="structure-list d-flex justify-content-between border-bottom">
                                <p class="mb-0"><i
                                        class="las la-dot-circle fs-18 text-primary me-2"></i>{{ __('translation.Unpaid') }}
                                </p>
                                <div>
                                    <span class="badge bg-primary" id="pendingAmt"> ${{ $totalAmountOfPendingInvoices }}
                                    </span>
                                    <input type="hidden" id="pendingAmount"
                                        value="{{ $totalAmountOfPendingInvoices }}">
                                </div>
                            </div>
                            <div class="structure-list d-flex justify-content-between pb-0">
                                <p class="mb-0"><i
                                        class="las la-dot-circle fs-18 text-primary me-2"></i>{{ __('translation.Cancelled') }}
                                </p>
                                <div>
                                    <span class="badge bg-primary" id="cancelAmt"> ${{ $totalAmountOfCancelInvoices }}
                                    </span>
                                    <input type="hidden" id="cancelledAmount"
                                        value="{{ $totalAmountOfCancelInvoices }}">
                                </div>
                            </div>
                        </div>
                                    ...
                                    @if (count($clients) > 0)
                                        @foreach ($clients as $key => $client)
                                            <tr>
                                                ...
                                                <td><img src="/build/images/users/{{ $client->profile_image }}"
                                                        alt="" class="avatar-xs rounded-circle me-2">
                                                    <a href="#javascript: void(0);"
                                                        class="text-body align-middle">{{ $client->first_name . ' ' . $client->last_name }}</a>
                                                </td>
                                                <td>{{ $client->email }}</td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip"
                                                            ...
                                                            title="Make Invoice">
                                                            <a href="{{ url('make-invoice', $client->id) }}"
                                                                class="btn btn-soft-warning btn-sm d-inline-block"><i
                                                                    class="las la-file-invoice"></i></a>
                                                        </li>
                                                    </div>
                                                </td>
                                            </tr>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-header align-items-center d-flex pb-2">
                        ...
                        <div class="flex-shrink-0 ms-2">
                            <div class="dropdown">
                                <input type="date" class="form-control" id="overviewYearPicker"
                                    name="overviewYearPicker" placeholder="Select year">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-0">
                        <div id="payment-overview" data-colors='["--in-primary", "--in-light"]' class="apex-charts"
                            dir="ltr"></div>
                        <div class="row mt-3 text-center">
                            <div class="col-6 border-end">
                                <div class="my-1">
                                    <p class="text-muted text-truncate mb-2">{{ __('translation.Paid Amount') }}</p>
                                    <h4 class="mt-2 mb-0 fs-20" id="overViewPaidAmt">${{ $totalAmountOfPaidInvoices }}
                                    </h4>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="my-1">
                                    ...
                                    <h4 class="mt-2 mb-0 fs-20" id="overViewUnpaidAmt">
                                        ${{ $totalAmountOfPendingInvoices }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                @foreach ($allTransactions as $key => $transaction)
                                    <div class="border-bottom sales-history">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-shrink-0">
                                                <span
                                                    class="badge fs-12 badge-soft-success">${{ $transaction->amount }}</span>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 ms-3 overflow-hidden text-center">
                                            <h5 class="fs-15 mb-1 text-truncate">
                                                {{ __('translation.No Transaction Found') }}</h5>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                    ...
                                    <table class="table table-bordered table-centered align-middle table-nowrap mb-0">
                                        <thead class="table-primary">
                                            <tr>
                                                ...
                                                <th>{{ __('translation.Orders') }}</th>
                                                <th>{{ __('translation.Earning') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex-grow-1 ms-3">
                                                                    <p class="mb-0 text-truncate">{{ $value['country'] }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </td>
                                            ...
                                            @else
                                                <tr colspan="3">
                                                    <td class="d-flex align-items-center">
                                                        {{ __('translation.No Transaction Found') }}</td>
                                                </tr>
                                            @endif
                                        </tbody>
                                    </table>
            ...
            <div class="col-xl-5">
                <div class="card card-height-100">
                    <div class="card-header">
                        <h5 class="card-title mb-0">{{ __('translation.Latest Invoice List') }}</h5>
                    </div>
                                ...
                                <tbody>
                                    @if (count($allInvoices) > 0)
                                        @foreach ($allInvoices as $key => $invoice)
                                            <tr>
                                                <td>
                                                    <p class="mb-0 fs-14">{{ $invoice->invoice_number }}</p>
                                                </td>
                                                <td>
                                                    <a href="#javascript: void(0);"
                                                        class="text-body align-middle">{{ $invoice->client->first_name . ' ' . $invoice->client->last_name }}</a>
                                                </td>
                                                ...
                                                ?>
                                                <td><span
                                                        class="badge badge-soft-{{ $statusColor }} p-2">{{ $statusValue }}</span>
                                                </td>
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('view-invoice', $invoice->id) }}"><i
                                                            ...
                                                            @if ($invoice->payment_status != 1)
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('edit-invoice', $invoice->id) }}"><i
