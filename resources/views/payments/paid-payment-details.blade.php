                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-tabs-custom nav-success mb-3" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ url('paid-payment') }}" role="tab"
                                    aria-selected="false">
                                    {{ __('translation.Paid') }}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('pending-payment') }}" role="tab"
                                    aria-selected="false">
                                    {{ __('translation.Pending') }}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('cancel-payment') }}" role="tab"
                                    aria-selected="false">
                                    {{ __('translation.Cancelled') }}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('refunded-payment') }}" role="tab"
                                    aria-selected="false">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col" style="width: 16%;">
                                                            {{ __('translation.Payment Type') }}</th>
                                                        <th scope="col" style="width: 12%;">
                                                            {{ __('translation.Amount') }}</th>
                                                        <th scope="col" style="width: 12%;">
                                                            {{ __('translation.Status') }}</th>
                                                        <th scope="col" style="width: 12%;">
                                                            {{ __('translation.Action') }}</th>
                                                    </tr>
                                                </thead>
