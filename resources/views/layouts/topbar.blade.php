            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="{{ url('dashboard') }}" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{URL::asset('build/images/'.setting('logo_sm'))}}" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="{{URL::asset('build/images/'.setting('dark_logo'))}}" alt="" height="21">
                        </span>
                    </a>
                    ...
                    <a href="{{ url('dashboard') }}" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="{{URL::asset('build/images/'.setting('light_logo'))}}" alt="" height="21">
                        </span>
                    </a>
                </div>
                                            ...
                                            <div class="d-flex">
                                                <div class="avatar-xs me-3">
                                                    <span class="avatar-title bg-soft-info text-info rounded-circle fs-16">
                                                        <img src="@if($item->user->profile_image != ''){{ URL::asset('build/images/users/' . $item->user->profile_image) }}@else{{ URL::asset('build/images/users/user-dummy-img.jpg') }}@endif" class="mr-3 rounded-circle avatar-xs" alt="user-pic">
                                                    </span>
                                                </div>
                                                <div class="flex-1">
                ...
                <div class="dropdown header-item">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{URL::asset('build/images/users/'.$user->profile_image)}}" alt="Header Avatar">
