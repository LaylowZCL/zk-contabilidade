...
<head>
    <meta charset="utf-8" />
    <!-- Bootstrap Css -->
    <link href="{{public_path().'/build/css/bootstrap.min.css'}}" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    <link href="{{public_path().'/build/css/icons.min.css'}}" rel="stylesheet" type="text/css" />
</head>
<body>
                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-lg-3">
                            <div class="mt-sm-0 mt-3">
                                <div class="">
                                    <img src="{{ public_path().'/build/images/logo/'.$invoiceDetails['company']['logo'] }}" class="card-logo card-logo-dark" alt="logo dark" height="100">
                                    <img src="{{ public_path().'/build/images/logo/'.$invoiceDetails['company']['logo'] }}" class="card-logo card-logo-light" alt="logo light" height="100">
                                </div>
