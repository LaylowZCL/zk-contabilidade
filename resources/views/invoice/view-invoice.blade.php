                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-lg-3">
                            <div class="mt-sm-0 mt-3">
                                <div class="">
                                    <img src="{{URL::asset('/build/images/logo/'.$invoiceDetails->company->logo)}}" class="card-logo card-logo-dark" alt="logo dark" height="100">
                                    <img src="{{URL::asset('/build/images/logo/'.$invoiceDetails->company->logo)}}" class="card-logo card-logo-light" alt="logo light" height="100">
                                </div>
