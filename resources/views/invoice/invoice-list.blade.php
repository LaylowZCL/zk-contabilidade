...
@section('body')
    ...
    @section('content')
        ...
        if (count($sentInvoices) > 0) {
            ...
            if ($unpaidInvPercent > $paidInvPercent) {
                $paidSign = '-';
                $paidArrow = 'ri-arrow-right-down-line';
                $paidColor = 'danger';
            } else {
                $paidSign = '+';
                $paidArrow = 'ri-arrow-right-up-line';
                $paidColor = 'success';
            }
        
            if ($unpaidInvPercent < $paidInvPercent) {
                $unpaidSign = '-';
                $unpaidArrow = 'ri-arrow-right-down-line';
                $unpaidColor = 'danger';
            } else {
                $unpaidSign = '+';
                $unpaidArrow = 'ri-arrow-right-up-line';
                $unpaidColor = 'success';
            }
        }
        ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h4 class="fs-22 fw-semibold ff-secondary mb-2">$<span class="counter-value"
                                        data-target="{{ $totalAmountOfSentInvoices }}">0</span></h4>
                                <p class="text-uppercase fw-medium fs-14 text-muted mb-0">
                                    {{ __('translation.Invoice Sent') }}
                                </p>
                            </div>
                        ...
                        <div class="d-flex align-items-end justify-content-between mt-4">
                            <div>
                                <span class="badge bg-primary me-1">{{ count($sentInvoices) }}</span> <span
                                    class="text-muted">{{ __('translation.Invoice Sent') }}</span>
                            </div>
                        </div>
                    </div><!-- end card body -->
                </div><!-- end card -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h4 class="fs-22 fw-semibold ff-secondary mb-2">$<span class="counter-value"
                                        data-target="{{ $totalAmountOfPaidInvoices }}">0</span></h4>
                                <p class="text-uppercase fw-medium fs-14 text-muted mb-0">
                                    {{ __('translation.Paid Invoice') }}
                                    <span class="text-{{ $paidColor }} fs-14 mb-0 ms-1">
                                        <i class="{{ $paidArrow }} fs-13 align-middle"></i>
                                        {{ $paidSign }}{{ $paidInvPercent }} %
                                    </span>
                                </p>
                            </div>
                            <div class="avatar-sm flex-shrink-0">
                        ...
                        <div class="d-flex align-items-end justify-content-between mt-4">
                            <div>
                                <span class="badge bg-primary me-1">{{ count($paidInvoices) }}</span> <span
                                    class="text-muted">{{ __('translation.Paid by clients') }}</span>
                            </div>
                        </div>
                    </div><!-- end card body -->
                </div><!-- end card -->
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-primary">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h4 class="fs-22 fw-semibold ff-secondary mb-2 text-white">$<span class="counter-value"
                                        data-target="{{ $totalAmountOfPendingInvoices }}">0</span></h4>
                                <p class="text-uppercase fw-medium fs-14 text-white-50 mb-0">
                                    {{ __('translation.Unpaid Invoice') }}
                                    <span class="text-{{ $unpaidColor }} fs-14 mb-0 ms-1">
                                        <i class="{{ $unpaidArrow }} fs-13 align-middle"></i>
                                        {{ $unpaidSign }}{{ $unpaidInvPercent }} %
                                    </span>
                                </p>
                            </div>
                            <div class="avatar-sm flex-shrink-0">
                        ...
                        <div class="d-flex align-items-end justify-content-between mt-4">
                            <div>
                                <span class="badge bg-danger me-1">{{ count($pendingInvoices) }}</span> <span
                                    class="text-white">{{ __('translation.Unpaid by clients') }}</span>
                            </div>
                        </div>
                    </div><!-- end card body -->
                </div><!-- end card -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <h4 class="fs-22 fw-semibold ff-secondary mb-2">$<span class="counter-value"
                                        data-target="{{ $totalAmountOfCancelInvoices }}">0</span></h4>
                                <p class="text-uppercase fw-medium fs-14 text-muted mb-0">
                                    {{ __('translation.Cancelled Invoices') }}
                        ...
                        <div class="d-flex align-items-end justify-content-between mt-4">
                            <div>
                                <span class="badge bg-primary me-1">{{ count($cancelInvoices) }}</span> <span
                                    class="text-muted">{{ __('translation.Cancelled by clients') }} </span>
                            </div>
                        </div>
                    </div><!-- end card body -->
                </div><!-- end card -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive table-card">
                            <table class="table nowrap dt-responsive align-middle table-hover table-bordered mb-0" id="invoiceListTable">
                                <thead>
                                    <tr>
